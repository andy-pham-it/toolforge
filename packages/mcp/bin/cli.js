 ...
 * Supports Groq (preferred) and Gemini providers via environment variables.
 *
...
if (process.env.GROQ_API_KEY) {
    ...
    console.error('Either GROQ_API_KEY or GEMINI_API_KEY environment variable is required');
    process.exit(1);
}
