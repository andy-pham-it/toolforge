...
| `@andy-toolforge/sprint-retro` | [![npm](https://img.shields.io/npm/v/@andy-toolforge/sprint-retro)](https://npmjs.com/package/@andy-toolforge/sprint-retro) | Sprint retrospective: mine agent sessions, synthesize lessons, persist patterns | AI agents |
| `@andy-toolforge/knowledge-base` | [![npm](https://img.shields.io/npm/v/@andy-toolforge/knowledge-base)](https://npmjs.com/package/@andy-toolforge/knowledge-base) | Filesystem-first knowledge base facade: JSON store, CRUD/search, adapters | AI agents |
